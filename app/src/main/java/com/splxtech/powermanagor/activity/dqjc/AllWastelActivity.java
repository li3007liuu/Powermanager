...
/**
 * Created by li300 on 2016/11/9 0009.
 */

public class AllWastelActivity extends AppBaseActivity {
    ...
    private void initWasteMoneyDis()
    {
        ...
        if(wasteMoneyDisArrayList.size()==0)
        {
            for(int i=0;i<20;i++) {
                ...
                {
                    //waste = (int)(applianceList.get(j).getAppWasteAll().getDayWasteList().get(19-i).floatValue()+waste);
                }
                //waste = (int)(appliance.getAppWasteAll().getDayWasteList().get(19-i).floatValue());
    ...
    private void initWasteMoneyWeekDis()
    {
        ...
        for(int i=0;i<16;i++) {
            ...
            for(int j=0;j<applianceList.size();j++)
            {
                //waste = (int)(applianceList.get(j).getAppWasteAll().getWeeksWasteList().get(15-i).floatValue()+waste);
            }
            //float waste = (int)(appliance.getAppWasteAll().getWeeksWasteList().get(15-i).floatValue());
            float money = (float)(waste*0.53);
            String table;
            String xAxis;
            if(i==0)
    ...
    private void initWasteMoneyMouthDis()
    {
        ...
        for(int i=0;i<12;i++) {
            ...
            for(int j=0;j<applianceList.size();j++)
            {
               // waste = (int)(applianceList.get(j).getAppWasteAll().getMonthsWasteList().get(11-i).floatValue()+waste);
            }
            //float waste = (int)(appliance.getAppWasteAll().getMonthsWasteList().get(11-i).floatValue());
            float money = (float)(waste*0.53);
            String table;
            String xAxis;
            if(i==0)
